...
// Game Over Screen is the screen that you see when you lose the game. It has a button for retrying the game and another one for going back to the main menu.
